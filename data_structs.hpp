...
const short king_castle_long_cols_to_be_empty[3] = {3, 2, 1};
const short king_castle_long_cols_to_be_not_checked[2] = {3, 2};
const short king_castle_short_cols_to_be_empty_or_checked[2] = {5, 6};
